...
from app.api.v1.endpoints import (
    auth, users, chat, documents, tax_returns, tax_compute, 
    forms, operators, authorizations, audit, monitoring
)
...
api_router.include_router(tax_compute.router, prefix="/tax", tags=["tax-computation"])
